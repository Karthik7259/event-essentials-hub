...
const Auth = () => {
  ...
  const handleAdminLogin = async (e) => {
    ...
    try {
      ...
      const result = await authAPI.adminLogin(adminEmail, adminPassword);
      ...
      toast({ title: 'Error', description: 'Unable to login as admin', variant: 'destructive' });
    } finally {
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-secondary rounded-xl p-1 h-12">
              ...
              <TabsTrigger value="admin" className="rounded-lg text-sm font-medium data-[state=active]:bg-card data-[state=active]:shadow-sm">
                Admin
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="admin">
              <form onSubmit={handleAdminLogin} className="space-y-5">
                ...
                <p className="text-xs text-muted-foreground">Only authorized administrators can access the admin console.</p>
              </form>
            </TabsContent>
          </Tabs>
        </div>
