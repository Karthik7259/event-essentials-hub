  ...
  return (
    <>
      ...
      <Dialog open={videoOpen} onOpenChange={setVideoOpen}>
        <DialogContent className="max-w-5xl w-[95vw] p-0 bg-primary border-border overflow-hidden">
          <button
            onClick={() => setVideoOpen(false)}
            className="absolute top-4 right-4 z-50 w-10 h-10 rounded-full bg-primary/80 backdrop-blur-sm flex items-center justify-center text-primary-foreground hover:bg-primary transition-colors"
          >
            <X className="h-5 w-5" />
          </button>
