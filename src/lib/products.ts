...
export const products: Product[] = [
  ...
  { id: "2", name: "Octonorm Stall System", category: "stalls", description: "Modular octanorm exhibition stall system. Versatile and professional appearance for trade shows.", image: octonormStallImg, pricePerDay: 350, available: true, specifications: ["3m x 3m standard", "Customizable panels", "Lockable storage"] },
  ...
  // Flooring
  { id: "7", name: "Wooden Platform Module", category: "flooring", description: "Sturdy wooden platforms for elevated stages and walkways. Modular design for flexible configurations.", image: woodenPlatformImg, pricePerDay: 150, available: true, specifications: ["4ft x 4ft modules", "Non-slip surface", "Height adjustable legs"] },
  ...
  // Climate Control
  { id: "9", name: "Portable AC 2 Ton", category: "climate", description: "Industrial portable air conditioner for temporary cooling solutions at events.", image: portableAcImg, pricePerDay: 400, available: true, specifications: ["2 Ton capacity", "Quick cooling", "Low noise"] },
  ...
  // Lighting & Power
  { id: "11", name: "LED Par Light Set", category: "lighting", description: "Professional LED par lights for stage and event lighting. DMX compatible.", image: ledLightsImg, pricePerDay: 80, available: true, specifications: ["Set of 4 lights", "RGB colors", "DMX control"] },
  { id: "12", name: "Generator 25 KVA", category: "lighting", description: "Silent diesel generator for reliable power backup at events.", image: generatorImg, pricePerDay: 800, available: true, specifications: ["25 KVA output", "Silent operation", "Auto start"] },
  ...
  // Staging & Barriers
  { id: "14", name: "Stage Platform 20x16", category: "staging", description: "Professional stage platform with skirting. Ideal for performances and presentations.", image: stagePlatformImg, pricePerDay: 600, available: true, specifications: ["20ft x 16ft", "Adjustable height", "Includes skirting"] },
  { id: "15", name: "Iron Barricade Set", category: "staging", description: "Crowd control iron barricades for event management and safety.", image: barricadeImg, pricePerDay: 15, available: true, specifications: ["Set of 10", "Interlocking", "Heavy duty"] },
